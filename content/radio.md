...
description: 매주 새로운 AI 트렌드를 소개합니다. 이로와 루프가 한 주간 가장 핫했던 AI 뉴스를 전달합니다.
cssclass: radio
publish: true
lang: ko
tags:
...
<p>한 주간 쏟아진 AI 뉴스 중 가장 핫했던 하나를 이로와 루프가 전달합니다.</p>
...
<span class="ewa-radio-ep" id="ep-label">Episode 01 · 최신 에피소드</span>
<h2 id="ep-title">AI 미래예보: 모델·에이전트·로봇·크립토</h2>
<p id="ep-summary">이번 주 AI 생태계 전반의 방향성을 보여주는 네 영역의 소식. 모델은 검증된 결과를 가져오기 시작했고, 에이전트는 통제 없는 자율이 사고로 이어졌습니다. 로봇은 일상에 진입했고, 크립토는 규제와 연구 도구 양쪽에서 움직임이 있습니다.</p>
...
<div class="ewa-radio-archive-item is-active" data-ep="1" data-lang="ko">
<span class="ewa-radio-archive-num">EP 01</span>
<div>
<h4>AI 미래예보: 모델·에이전트·로봇·크립토</h4>
<span>2026-07-29 · 약 3분 · 한국어 · English · 日本語</span>
</div>
</div>
</div>
</section>
